    ...
    if(isset($_POST['submit'])){
        ...
        if($result->num_rows==1){
           $sql="UPDATE `inventory` SET `Stock`=`Stock`+'$stock',`Expiry_date`='$expdate',`price`='$price' WHERE `ProductName`='$name' AND`Store_id`='$store_id'";
            $result=$conn->query($sql);
            echo "<script>
                alert(' Inventory succefully updated ');
            </script>";
        }
...
<head>
    ...
    <script>
        ...
        window.location.href = "updateinventory.php?id=" + <?php echo $store_id?>;
}
...
<body>
    ...
    <div class="head">
        ...
        <div class="opt">
            ...
            <input type="text" id="search" placeholder="Search" onkeyup="search('<?php echo $store_id;?>');">
    ...
    <div class="Addform" >
        <form method="POST">
        <h3><i class="fa-solid fa-arrow-left" onclick=back2()></i></h3>
